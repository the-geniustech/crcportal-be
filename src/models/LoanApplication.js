...
export const LoanApplicationSchema = new Schema(
  {
    ...
    repaymentStartDate: { type: Date, default: null },
    nextInterestAccrualDate: { type: Date, default: null, index: true },
    ...
    principalOutstanding: { type: Number, default: 0, min: 0 },
    accruedInterestBalance: { type: Number, default: 0, min: 0 },
    totalPrincipalPaid: { type: Number, default: 0, min: 0 },
